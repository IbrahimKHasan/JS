...
console.log (`Your doggie is ${7*x} years old in dog years!`)
}
console.log('Ex.2---------------------------')
calculateDogAge(3)
/*
...
else if (y.length<=z.length && y.length<=a.length && y.length<=b.length){
console.log(y)
}
else if (z.length<=a.length && z.length<=b.length){
console.log(z)
}
...
function longerString(x,y,z,a){
  ...
  else if (y.length>=z.length && y.length>=a.length){
  console.log(y)
  }
  else if (z.length>=a.length){
  console.log(z)
  }
  else {
  console.log(a)
...
console.log(`${b} and the counter reset now`)
b=0
}
console.log('Ex.24---------------------------')
counter()
